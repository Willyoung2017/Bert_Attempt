...
from srl_model.allennlp.data.token_indexers import ELMoTokenCharactersIndexer
from srl_model.allennlp.modules.elmo import _ElmoCharacterEncoder
from srl_model.allennlp.data import Token, Vocabulary
from srl_model.allennlp.data.vocabulary import DEFAULT_OOV_TOKEN
from srl_model.allennlp.common.checks import ConfigurationError
