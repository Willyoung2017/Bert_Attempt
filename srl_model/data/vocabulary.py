...
from srl_model.common.util import namespace_match
from srl_model.common import Params, Registrable
from srl_model.common.checks import ConfigurationError
from srl_model.common.tqdm import Tqdm
from srl_model.data import instance as adi  # pylint: disable=unused-import
...
def _read_pretrained_tokens(embeddings_file_uri: str) -> Set[str]:
    ...
    from srl_model.modules.token_embedders.embedding import EmbeddingsTextFile
