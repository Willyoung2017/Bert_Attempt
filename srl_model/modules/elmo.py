...
from srl_model.common.file_utils import cached_path
from srl_model.common.checks import ConfigurationError
from srl_model.common import Params
from srl_model.common.util import lazy_groups_of
from srl_model.modules.elmo_lstm import ElmoLstm
from srl_model.modules.highway import Highway
from srl_model.modules.scalar_mix import ScalarMix
from srl_model.nn.util import remove_sentence_boundaries, add_sentence_boundary_token_ids, get_device_of
from srl_model.data.token_indexers.elmo_indexer import ELMoCharacterMapper, ELMoTokenCharactersIndexer
from srl_model.data.dataset import Batch
from srl_model.data import Token, Vocabulary, Instance
...
class _ElmoBiLm(torch.nn.Module):
    ...
    def create_cached_cnn_embeddings(self, tokens: List[str]) -> None:
        ...
        from srl_model.modules.token_embedders import Embedding # type: ignore
