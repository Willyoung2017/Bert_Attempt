...
from srl_model.modules.similarity_functions import DotProductSimilarity, SimilarityFunction
from srl_model.modules.similarity_functions import MultiHeadedSimilarity
