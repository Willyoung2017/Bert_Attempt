...
from srl_model.data.dataset_readers import LanguageModelingReader
...
class TestLanguageModelingDatasetReader:
    ...
    def test_read_from_file(self, lazy):
        ...
        instances = ensure_list(reader.read(AllenNlpTestCase.FIXTURES_ROOT / 'data' / 'language_modeling.txt'))
