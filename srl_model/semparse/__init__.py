...
# `from srl_model.semparse import [whatever]` in the `data` module, but it resolves the other
# dependency issues.  If you want to import semparse stuff from the data code, just use a more
# complete path, like `from srl_model.semparse.worlds import WikiTablesWorld`.
from srl_model.data.tokenizers import Token as _
from srl_model.semparse.worlds.world import ParsingError, World
from srl_model.semparse.action_space_walker import ActionSpaceWalker
